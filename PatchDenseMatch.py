...
def PatchDenseMatch(dataset_list):
    for dataset in dataset_list:
        ...
        result_dirtory = os.path.join(folder_path, "disp_res")
        ...
        for image_dir in image_dir_lsit:
            ...
            depth_out_dir = os.path.join(result_dirtory, dataset + "_" + data_name)
            StereoMathing(img1, img2, depth_out_dir)
            ...
            # mean_error, median_error, rmse, mae, keep_rate, num_inliers_F, num_pts, img_matches= EvaluateErrBetweenTwoImage(left_img_path, right_img_path, 3)
